 ...
 */
final class Version20220324114119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE nomc nomc VARCHAR(255) NOT NULL, CHANGE logo logo VARCHAR(255) NOT NULL, CHANGE descr descr VARCHAR(255) NOT NULL, CHANGE president president VARCHAR(255) NOT NULL, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club CHANGE id id INT NOT NULL, CHANGE nomc nomc VARCHAR(255) DEFAULT NULL, CHANGE logo logo VARCHAR(255) DEFAULT NULL, CHANGE descr descr VARCHAR(255) DEFAULT NULL, CHANGE president president VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE jour DROP FOREIGN KEY FK_DA17D9C5A6810A97');
